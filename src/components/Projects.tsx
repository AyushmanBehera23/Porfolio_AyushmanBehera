...
const projects = [
  {
    ...
    date: "2025",
    bullets: [
      "AI chatbot that verifies news credibility using Gemini API with real-time fact checking.",
      "Built with a Python FastAPI backend and a modern HTML/CSS/JS frontend for seamless user experience.",
    ],
